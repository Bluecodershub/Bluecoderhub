            ...
            <AnimatePresence mode="wait">
                <Suspense fallback={<LoadingFallback />}>
                    <Routes location={location} key={location.pathname}>
                        ...
                        <Route path={ROUTES.PRIVACY} element={<PageWrapper><Legal /></PageWrapper>} />
                        <Route path={ROUTES.TERMS} element={<PageWrapper><Legal /></PageWrapper>} />
                        <Route path={ROUTES.COOKIES} element={<PageWrapper><Legal /></PageWrapper>} />
